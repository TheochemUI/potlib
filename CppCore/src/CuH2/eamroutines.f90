      ...
      subroutine eamh2cu()
          ...
          do iCuCl = 1, nCuCl ! Loop over classical Cu atoms
              ...
              do jCuCl = iCuCl + 1, nCuCl ! Loop over classical Cu atoms
                  ...
                  do ixyz = 1, 3
                      ...
                      jcoo = 3 * (jat - 1) + ixyz
                      del = ra(jcoo) - ra(icoo)
                      if (ABS(del) > 0.5 * PL(ixyz)) del = del * (1.-PL(ixyz) / ABS(del))
                      sum2 = sum2 + del**2
                      dr(ixyz) = del
                  end do
              ...
              end do ! End loop over images in MAP chains
          end do ! End loop over classical Cu atoms
          ...
          do im = 1, nimpo * nimrp ! Loop again over images
              ...
              end do ! End loop using H atoms as atom i
          end do ! End loop over images
...
!:::::::::::::
      subroutine EAMFCu(rhotot, embedE, dFdrho)
          ...
          embedE = FCu1 * rhotot + FCu2 * rhotot2 + FCu3 * rhotot3 + FCu4 * rhotot4 + &
                   FCu5 * rhotot5 + FCu6 * rhotot6 + FCu7 * rhotot7 + FCu8 * rhotot8
          dFdrho = FCu1 + 2.*FCu2 * rhotot + 3.*FCu3 * rhotot2 + 4.*FCu4 * rhotot3 + &
                   5.*FCu5 * rhotot4 + 6.*FCu6 * rhotot5 + 7.*FCu7 * rhotot6 + &
                   8.*FCu8 * rhotot7
...
!:::::::::::::
      subroutine EAMRhoCu(R, rho, drhodroverr, indic)
          ...
          if (indic /= 0) drhodroverr = (netaCu * rho * Rinv - term3 * (betaACu * term1 + betaBCu * term2)) * Rinv
          rho = rho - rhocutCu
...
!:::::::::::::
      subroutine EAMRhoH(R, rho, drhodroverr, indic)
          ...
          rho = term3 * (term1 + term2)
          if (indic /= 0) drhodroverr = (netaH * rho * Rinv - term3 * (betaAH * term1 + betaBH * term2)) * Rinv
          rho = rho - rhocutH
      ...
      SUBROUTINE potinit()
          ...
          potpar(13, 2) = -3952.35
          potpar(13, 3) = 0.0
          potpar(14, 1) = .478009E+07
          potpar(14, 2) = 8767.87
          potpar(14, 3) = 0.0
          potpar(15, 1) = -.523419E+08
          potpar(15, 2) = -6599.37
          potpar(15, 3) = 0.0
          potpar(16, 1) = .339124E+09
          potpar(16, 2) = 0.0
          potpar(16, 3) = 0.0
          potpar(17, 1) = -.120150E+10
          potpar(17, 2) = 0.0
          potpar(17, 3) = 0.0
          potpar(18, 1) = .179619E+10
          potpar(18, 2) = 0.0
          potpar(18, 3) = 0.0
